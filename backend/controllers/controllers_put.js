...
const updateOneProject = (req, res) => {
    ...
    client.query(
        'UPDATE projets SET nom_projet = $1, description_projet = $2, recolte_projet = $3, admin_projet = $4 WHERE id_projet = $5', [nom_projet, description_projet, recolte_projet, admin_projet, id],
        (err, result) => {
            if (err) {
                console.log(err);
            }
