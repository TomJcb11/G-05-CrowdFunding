...
const submitDonation = async (req, res) => {
    ...
    try {
        ...
        await client.query('INSERT INTO investisseurs (id_projet, id_utilisateur, id_paiement, message_transaction, montant) VALUES ($1, $2, $3, $4, $5)', [id, id_utilisateur, moyen_paiement, message_don, montant_don]);
        await client.query('UPDATE PROJETS SET recolte_projet = recolte_projet + $1 WHERE id_projet = $2', [montant_don, id]);
